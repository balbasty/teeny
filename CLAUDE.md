...
t.index_select<Axis>(idx);         // gather along Axis by a rank-1 integer index
                      ...
                      //   idx shape -> stack result, else heap. Always a COPY (an arbitrary
                      //   data-dependent gather isn't an affine mdspan view). into(dest) form
                      //   too: t.index_select<Axis>(idx, into(dest)) (no alloc, device-safe)
