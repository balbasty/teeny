 ...
 ***********************************************************************/
#ifndef MINITEN_META_INDEX_IMPL_H
#define MINITEN_META_INDEX_IMPL_H
...
struct _WrapIndex<SizeT<Length>, PtrDiff<Indices...>> {
    using Type = WrapIndexValue<Length, Indices...>;
};

template <size_t Length, class START, class STOP, class STEP>
struct _WrapIndex<SizeT<Length>, Slice<START,STOP,STEP>> {
protected:
    using ThisSlice    = Slice<START,STOP,STEP>;
    using ThisLength   = SizeT<Length>;
    using SliceAsIndex = AsIndexVector<ThisSlice, Length>;
public:
    using Type = WrapIndex<ThisLength, SliceAsIndex>;
};

template <size_t Length, ptrdiff_t START, ptrdiff_t STOP, ptrdiff_t STEP>
struct _WrapIndex<SizeT<Length>, SimpleSlice<START,STOP,STEP>> {
protected:
...
/// The meta-templating equivalent of python's `slice`.
///
...
#endif // MINITEN_META_INDEX_IMPL_H
