...
int main() {
    ...
    auto t = wrap(buf, shape<2,3,4,5>{});      // rank 4

    // single named axis (integer) -> drop it
    auto a = t.slice_along<1>(2);                       // axis1=2 -> (2,4,5)
