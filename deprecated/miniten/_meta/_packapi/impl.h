#ifndef MINITEN__META__PACKAPI_IMPL
#define MINITEN__META__PACKAPI_IMPL
#include <miniten/_core/defines.h>
#include <miniten/_core/types.h>            // size_t, ptrdiff_t
#include <miniten/_meta/_packapi/decl.h>
#include <miniten/_meta/_pack/decl.h>       // Pack
#include <miniten/_meta/_vector/decl.h>     // PtrDiff
#include <miniten/_meta/_math/decl.h>       // IsZero, IsEqual
...
{
    using Type = SetFrom<A, I, Cat<LikeFrom<A,M0>, M...>>;
};
...
#endif // MINITEN__META__PACKAPI_IMPL
